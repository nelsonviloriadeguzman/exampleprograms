window.onload = () => {
    ...
    for(let dataCount = 0; dataCount < multiData.length; dataCount++){
        ...
        <div class="cards flex-wrap justify-between w-1/2 mr-30">
            <div class="relative block sm:flex md:flex items-center bg-purple-600" style="min-height: 19rem;">
                ...
                <div class="w-full h-full w-3/5 flex items-center bg-purple-600">
                    ...
                    <a class="bg-purple-600 text-white px-25" href="">CHECK NOW</a>
                    </div>
                    <svg class="hidden sm:block absolute inset-y-0 h-full w-24 fill-current text-purple-600 -ml-12" viewBox="0 0 100 100" preserveAspectRatio="none">
        ...
        <div class="flex items-center justify-center">
            <div class="w-2/3 rounded-lg">
                <div class="flex items-center justify-center pt-10 flex-col">
                    ...
                    <h1 class="text-purple-600 font-semibold text-xl mt-2">${multiData[dataCount].title}</h1>
    ...
    for(let dataCount = 0; dataCount < multiData.length; dataCount++){
        ...
        <div class="shadow-md flex bg-white rounded-lg p-6 leading-normal">
            ...
            <div>
                <h1 class="text-purple-600 font-bold">${multiData[dataCount].title}</h1>
